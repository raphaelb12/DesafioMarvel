        ...
        <div className="container">
          {loadCharacters.map((character) => (
            <div key={character.id} className="card">
               <img className="img-container" src={`${character.thumbnail.path}.${character.thumbnail.extension}`} alt={character.name} />
